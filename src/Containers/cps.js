    ...
    <div className="cps">
      ...
      <div className="pujasamiti">
        ...
        <Fade bottom className="headdesc">
          <h1>चित्रगुप्त पूजा समिति</h1>
          <div className="strength">
            <h3>कुल सदस्यों की संख्या : </h3>
            <h3>स्थापित : १९३१</h3>
          </div>
          <p>
            ।। श्री चित्रगुप्ताय नमः ।।<br />
            जब से इस धरती पर चित्रांशों की उत्पत्ति हुई है तब से वे अपने कूल देव या इष्ट देव भगवान् श्री चित्रगुपत जी की पूजा करते
            आए हैं। यहाँ केनर चट्टी में भी यह परंपरा न जाने कब से चली आ रही है। यह समिति कोई विशेष काम नहीं कर रही बल्कि यह
            तो केवल अपने इस वंशानुगत दायित्व का पालन कर रही है। यहाँ होने वाले वार्षिक चित्रगुप्त पूजा महोत्सव के विभिन्न आयोजनों में
            होने वाले व्यय और उनमे प्रयुक्त होने वालीं वस्तुओं का हिसाब किताब करना ही इस समिति का मुख्य कार्य है, जो कि यह
            समिति अपने सम्पूर्ण कौशल के साथ पूर्ण करती है।
          </p>
        </Fade>
        ...
        <Fade bottom className="cpshead3">
          ...
          <div className="anyalog">
            <img className="adhyaksh3" src="/Images/commit/Sandeep.jpg" alt="" />
          ...
          <div className="anyalog">
            <img className="adhyaksh3" src="/Images/commit/Chikki.jpg" alt="" />
            <h3>अभिजीत कुमार सिन्हा</h3>
          </div>
          <div className="anyalog">
