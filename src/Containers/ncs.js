...
const ncs = () => (
    <div className="ncs">
      ...
      <div className="pujasamiti">
        ...
        <Fade bottom className="headdesc">
          <h1>नवयुवक चित्रगुप्त संघ</h1>
          <div className="strength">
            <h3>कुल सदस्यों की संख्या : २५</h3>
            <h3>स्थापित : २००९</h3>
          </div>
          <p>चित्रांश परिवार केनर चट्टी के नौजवान युवकों का यह समूह हर मुमकिन तरह से इस समाज के उत्थान के लिए अपनी भागीदारी देने
            को तत्पर रहता है। इस समिति का हर सदस्य यहाँ होने वाले किसी भी आयोजन में किसी भी तरह का सहयोग देने के लिए आगे
            खड़ा रहता है फिर चाहे वो आयोजन सामाजिक हो या व्यक्तिगत। यह समिति हर वर्ष ₹६०० प्रति सदस्य की दर से ₹१५,००० की राशि
            जमा करती है जिसे या तो उस वर्ष होने वाले चित्रगुप्त पूजा में आ रहे कुछ आर्थिक कमियों की पूर्ति में लगाया जाता है या फिर कुछ ऐसी
            वस्तुएं खरीदने के लिए इस्तेमाल किया जाता है जो कि न केवल मंदिर के लिए बल्कि पुरे समाज के लिए उपयोगी हो और जिसे एक
            न्यूनतम शुल्क* देकर इस समाज का कोई भी परिवार अपने व्यक्तिगत आयोजनों में इस्तेमाल कर सकते हैं।
            <br />* इस शुल्क का इस्तेमाल उन वस्तुओं के रख रखाव में किया जाता है।
          </p>
        </Fade>
        <Fade bottom><h1>पदभार</h1></Fade>
        <hr />
        ...
        <Fade bottom className="anya">
          <h2>अन्य सदस्य</h2>
        </Fade>
        <Fade bottom className="cpshead3">
          <div className="anyalog">
            <img className="adhyaksh3" src="/Images/commit/Sanjay.jpg" alt="" />
            <h3>श्री संजय कुमार सिन्हा</h3>
          </div>
          <div className="anyalog">
          ...
          <div className="anyalog">
            <img className="adhyaksh3" src="/Images/commit/Anand.jpg" alt="" />
            <h3>श्री आनंद मोहन सरोज</h3>
          </div>
          <div className="anyalog">
          ...
          <div className="anyalog">
            <img className="adhyaksh3" src="/Images/commit/Mukesh.jpg" alt="" />
            <h3>मुकेश कुमार सिन्हा</h3>
          </div>
          <div className="anyalog">
